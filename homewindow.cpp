...
homewindow::homewindow(QString *username, QString *Password, QWidget *parent) :
    ...
    ui->setupUi(this);
    QPixmap bkgnd("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/#68246a.png");
    bkgnd = bkgnd.scaled(this->size(), Qt::IgnoreAspectRatio);
    QPalette palette;
    palette.setBrush(QPalette::Background, bkgnd);
    this->setPalette(palette);
    QPixmap logo ("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/the-chinese-university-of-hong-kong-logo-F21185E146-seeklogo.com.png");

    ui->label_pic->setPixmap(logo);
    ui->pushButton->setIcon(QIcon("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/dashboardsmall1.png"));
    ui->pushButton->setIconSize(QSize(18,18));
    ui->pushButton_2->setIcon(QIcon("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/PngItem_3560316(1).png"));
    ui->pushButton_2->setIconSize(QSize(20,20));
    ui->pushButton_6->setIcon(QIcon("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/teacherssmall1.png"));
    ui->pushButton_6->setIconSize(QSize(20,20));
    ui->pushButton_13->setIcon(QIcon("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/signoutsmall1.png"));
    ui->pushButton_13->setIconSize(QSize(20,20));
    ui->pushButton_12->setIcon(QIcon("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/Command-Reset-256.png"));
    ...
    QScrollArea *scrollArea = ui->scrollArea; // Assuming scrollArea is added in your .ui file
        ...
        while (query.next()) {
            ...
            announcementBox->setStyleSheet("border: 1px solid gray; background-color: white; border-radius: 15px; margin: 5px; padding: 10px;");

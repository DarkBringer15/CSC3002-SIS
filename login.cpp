...
{
    ui->setupUi(this);
    QPixmap bkgnd("C:/Users/Nick/Documents/Qt Project/LoginPage_1/Assets/background.png");
    bkgnd = bkgnd.scaled(this->size(), Qt::IgnoreAspectRatio);
    QPalette palette;
    palette.setBrush(QPalette::Background, bkgnd);
    this->setPalette(palette);
    QPixmap logo ("C:/Users/Nick/Documents/Qt Project/CSC3002/Assets/Emblem_of_CU.png");
